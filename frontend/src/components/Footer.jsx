      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            {/* Navigation */}
            <div>
              <h4 className="flex items-center gap-2 text-xs font-extrabold text-[var(--color-text)] uppercase tracking-widest mb-4" style={{ fontFamily: "var(--font-display)" }}>
                <i
            ...
            {/* Newsletter */}
            <div>
              <h4 className="flex items-center gap-2 text-xs font-extrabold text-[var(--color-text)] uppercase tracking-widest mb-3" style={{ fontFamily: "var(--font-display)" }}>
