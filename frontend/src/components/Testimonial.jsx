...
import { initialTestimonials } from "../data/testimonialData.jsx";
...
const Testimonials = () => {
  ...
  // Load testimonials from localStorage or initial data
  useEffect(() => {
    try {
      ...
      if (stored) {
        ...
        localStorage.setItem("portfolio_testimonials", JSON.stringify(initialTestimonials));
      }
    } catch (error) {
  ...
  // Handle form submission (Pure Frontend with localStorage)
  const handleSubmit = () => {
