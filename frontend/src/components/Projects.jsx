  ...
  return (
    <StaggerItem variant="fade-up">
      <article
        ...
        className="bento-card rainbow-card group relative overflow-hidden h-full flex flex-col justify-between"
        style={{
      ...
      >
        <div>
          ...
          <div className="mb-4 relative z-10 ">
            ...
            <h3
              className="text-xl font-extrabold text-[var(--color-text)] mb-2 group-hover:text-[var(--color-accent)] transition-colors group-hover:font-bold group-hover:text-white"
