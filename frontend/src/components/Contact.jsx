    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-6 max-w-5xl mx-auto">
          {/* Contact Info Cards */}
          <StaggerContainer amount={0.1} className="lg:col-span-2 space-y-4">
            {contactData.socials.map((item) => (
              <StaggerItem key={item.label} variant="slide-left">
                <a
                  href={
                  ...
                  className="bento-card rainbow-card flex items-center gap-4 group"
                  style={{
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <span
                      className="font-extrabold text-[var(--color-text)] block group-hover:text-[var(--color-accent)] transition-colors"
                      style={{ fontFamily: "var(--font-display)" }}
                    >
                      {item.label}
                    </span>
          ...
          <SectionReveal
            variant="slide-right"
            delay={0.2}
            className="lg:col-span-3 bento-card rainbow-card"
            style={{
              borderRadius: "var(--radius-xl)",
            }}
          >
            <h3
              className="text-lg font-extrabold text-[var(--color-text)] mb-5 flex items-center gap-2"
              style={{ fontFamily: "var(--font-display)" }}
            >
